...
//
1//v// class Car {
//     constructor(model, year, maxSpeed, capacity) {
//         this.model = model;
//         this.year = year;
...
//     }
//
//     addDriver = function (driver = {name, age, experience}) {
//         this.driver = driver;
//     }
// }
//
// let bmw = new Car('M5', 2006, 250, 5.0);
// console.log(bmw);
// bmw.drive();
// bmw.info();
// // bmw.increaseMaxSpeed(400);
// // bmw.change(2010);
// bmw.addDriver({name: 'Stig', age: 40, experience: 22})
2//v//let car = {
// manufacturer: 'BMW',
//     model: 'M5',
//     year: 2006,
